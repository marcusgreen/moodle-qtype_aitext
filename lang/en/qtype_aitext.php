...
$string['gentestresponses'] = 'Generate test responses';
$string['gentestresponses_help'] = 'Ask the AI to generate a spread of varied-quality sample responses based on the current question text, prompt and mark scheme, and add them to the sample response fields below. The first response is always a random nonsense string so the marking guide can be checked against garbage input; the rest range from excellent down to poor. This is a developer aid for testing the marking guide at every quality level.';
$string['gentestresponsesempty'] = 'Make sure that you have an AI prompt before generating test responses.';
$string['gentestresponsesfailed'] = 'The AI did not return any usable test responses. Try again.';
$string['gentestresponseswritten'] = '{$a} test responses added to the sample response fields.';
$string['numtestresponses'] = 'Number of test responses to generate';
