...
$string['privacy:preference:responserequired'] = 'Whether a text response is required by default.';
...
$string['cron_batch_size_setting'] = 'Maximum number of AI grading jobs processed by one scheduled task run. Values are limited to 1–100 to protect cron capacity.';
$string['cron_max_attempts'] = 'Maximum AI grading retries';
$string['cron_max_attempts_setting'] = 'Maximum number of attempts for a failed AI grading job before it is marked as failed. Values are limited to 1–20.';
$string['cron_retry_delay'] = 'AI grading retry delay';
$string['cron_retry_delay_setting'] = 'Initial delay in seconds before retrying a failed AI grading job. The delay increases with each attempt and is limited to 60–3600 seconds.';
